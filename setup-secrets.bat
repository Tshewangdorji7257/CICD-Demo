...
echo    - Navigate to: Account Settings → API Token
...
echo    - Click on your profile → My Account
...
echo • Project SonarCloud: https://sonarcloud.io/organizations/tshewangdorji7257
echo.
...
echo 🎉 Once configured, your security pipeline will:
echo • Scan for vulnerabilities on every push/PR
echo • Upload results to GitHub Security tab
echo • Enforce quality gates
echo • Monitor dependencies continuously
echo.
